...
function LatestPost() {
  ...
  const HandleComment = async (e) =>{
    try {
       ...
       const res = await fetch("http://localhost:3001/post/comment",{method: 'POST',
        headers: { 
  ...
  const HandleDeletePost = async (e) =>{
    try {
       e.preventDefault();
       const id = e.target.value;
       const res = await fetch("http://localhost:3001/post/delete",{method: 'POST',
        headers: { 
          Accept: "application/json",
          "Content-Type": "application/json"
        },
  ...
  const HandleUnLike = async (e) =>{
    try {
       e.preventDefault();
       const id = e.target.value;
       const res = await fetch("http://localhost:3001/post/unlike",{method: 'POST',
        headers: { 
          Accept: "application/json",
          "Content-Type": "application/json"
        },
  ...
  const HandleLike = async (e) =>{
     try {
        e.preventDefault();
        const id = e.target.value;
        const res = await fetch("http://localhost:3001/post/like",{method: 'POST',
         headers: { 
           Accept: "application/json",
           "Content-Type": "application/json"
         },
  ...
  const fetchPosts = async () =>{
    try {
         const apiurl = "http://localhost:3001/latest/posts";
